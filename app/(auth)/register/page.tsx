  ...
  return (
    <div className="min-h-screen bg-brand-surface flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md p-10 border border-brand-gold/20 bg-brand-surface-2">
        <h1 className="text-2xl font-bold text-brand-text uppercase tracking-widest text-center mb-8">Request Clearance</h1>
        <form className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-brand-gold tracking-[0.2em] uppercase">Full Name</label>
            <input 
              type="text" 
          ...
          <Button className="w-full py-5">INITIALIZE CLEARANCE</Button>
        </form>
        <div className="mt-8 pt-8 border-t border-brand-gold/5 text-center">
          <p className="text-[10px] text-brand-text/40 tracking-widest uppercase">
            Already Clearance? <Link href="/login" className="text-brand-gold hover:underline">Access Terminal</Link>
          </p>
        </div>
      </div>
    </div>
